...
import Login_img from "./images/LoginBG12.png";
...
function Login({ isAuth }) {
  ...
  const getIndividualUser = async (id) => {
    try {
      ...
      navigate("");
    } catch (e) {
      setIsLoggingIn(false);
  ...
  const postUserData = async (uid) => {
    try {
      await createUser({
        collectionRef: usersCollectionRef,
        data: { id: uid, email, phone,instituteName, username },
      });
    ...
    <Components.Container>
      <Components.SignUpContainer signingIn={isSignup}>
        ...
        <h1 id="head_login">Create Account</h1>
          ...
          <Components.Input onChange={(e) => setInstituteName(e.target.value)} type="text" placeholder="Institute Name" />
